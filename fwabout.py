...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_fromUtf8("<html><head></head><body>\
            <br/><br/>Ahtapot GDYS arayüz uygulaması,<br/> güvenlik duvarlarına uygulanacak<br/> yapılandırma kuralları\
            ile <br/>git sunucusu arasında köprü görevi<br/> görmektedir.<br/> \
            <br/><br/><br/>Ayrıca bu arayüz, FWBuilder<br/> uygulamasını kullanan mevcut<br/> kullanıcıyı da görüntüler ve <br/>kullanıcının oturumunu sonlandırma <br/>yetisine sahiptir.<br/>\
            </body></html>"))
